 ...
 * automatically by @tludlow-instana-fork/collector and the Node.js runtime. However, there are libraries that break async_hook
 * continuity. These methods enable users of @tludlow-instana-fork/collector to work around these issues.
 */
